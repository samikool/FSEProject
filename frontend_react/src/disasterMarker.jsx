...
export default class DisasterMarker extends Component{
    constructor(props){
        super(props);
        this.state = {"isShown":false, "setIsShown":false};
    }
            ...
            <Modal size={'mini'} trigger={
                ...
                />}>
                    ...
                    <Modal.Content image>
                        ...
                        <Modal.Description>
                        <Header>Disaster Properties</Header>
                            <p>Name: Example Name</p>
                            <p>Desciption: Brief description of the disaster</p>
                            <p>Type: Example Type (ie. Fire)</p>
                            <p>Location: Example Location (ie. Chicago, IL)</p>
                            <p>Keywords: Example Keywords</p>
                        </Modal.Description>
                    </Modal.Content>
                </Modal>
            </div>
